...
from model import EncoderCNN, DecoderRNN, path_to_data
...
def main(args):
    ...
    #print("encoder contructed****")
    decoder = DecoderRNN(args.embed_size, args.hidden_size,
                         len(vocab), args.num_layers)
    #print("decoder contructed****")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='./models/policyNet/' ,
